...
class _NeetEligibilityState extends State<NeetEligibility> {
                        ...
                        child: TextButton(
                          onPressed: () {
                            if (!checkValidation()) {
                              ...
                              int total =
                              int.parse(physicsTheoryController.text);
                              total +=
                                  int.parse(physicsPracticalController.text);
                              total +=
                                  int.parse(chemistryTheoryController.text);
                              total +=
                                  int.parse(chemistryPracticalController.text);
                              total += int.parse(biologyTheoryController.text);
                              total +=
                                  int.parse(biologyPracticalController.text);
                              setState(() {
                                print("HOOOOOO");
  ...
  bool checkValidation() {
    if (!checkValidation2(
        100, chemistryTheoryController, "Chemistry", "theory")) {
      return false;
    } else if (!checkValidation2(
        50, chemistryPracticalController, "Chemistry", "practical")) {
      return false;
    } else if (!checkValidation2(
        100, physicsTheoryController, "Physics", "theory")) {
      return false;
    } else if (!checkValidation2(
        50, physicsPracticalController, "Physics", "practical")) {
      return false;
    } else if (!checkValidation2(
        100, biologyTheoryController, "Biology", "theory")) {
      return false;
    } else if (!checkValidation2(
        50, biologyPracticalController, "Biology", "practical")) {
      return false;
    }
    return true;
  }
          ...
          return CustomAlertDialog(
            ...
            content: Column(children: [
              ...
              Container(
                ...
                child: CustomText("Enter the $subject marks"),
              ),
              Container(
                alignment: Alignment.centerRight,
                child: InkWell(
          ...
          return CustomAlertDialog(
            ...
            content: Column(children: [
              ...
              Container(
                ...
                alignment: Alignment.topLeft,
                child: CustomText(
                    "Enter $subject $type marks from 0 to ${maxMarks}"),
              ),
              Container(
                alignment: Alignment.centerRight,
                child: InkWell(
